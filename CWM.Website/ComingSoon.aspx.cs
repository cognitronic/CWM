        ...
        protected void NewsletterClicked(object o, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    var messageSent = EmailUtils.SendEmail(tbEmail.Text.Trim(), "Newsletter@modesto-family.com", "", ConfigurationManager.AppSettings["NEWSLETTER_EMAIL_RECIPIENTS"], "Thank You For Registering With Modesto.com!", sb.ToString().Trim(), false, "");
                }
                catch (Exception exc)
                {
