...
namespace CWM.Web.Utils
{
    public class HttpPageHelper
    {
        ...
        public static Poll CurrentPll
        {
            get { return HttpContextHelper.Get<Poll>("SQ_CURRENTPOLL"); }
            set { HttpContextHelper.Set("SQ_CURRENTPOLL", value); }
        }
    }
}
