...
{
    public partial class Subscribers : CWMAdminBasePage
    {
        #region Events
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //ram.AjaxSettings.AddAjaxSetting(rgSubscribers, rgSubscribers);
            if (!IsPostBack)
            {
        ...
        protected void AddTagsClicked(object o, EventArgs e)
        {
            ...
            Session["IsAdd"] = true;
            Response.Redirect("ManageSubscribersTags.aspx");
        }
        ...
        {
            Response.Redirect("ImportSubscribers.aspx");
        }
