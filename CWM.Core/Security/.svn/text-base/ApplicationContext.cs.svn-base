...
namespace CWM.Core.Security
{
    public class ApplicationContext
    {
        ...
        public static Poll CurrentPoll
        {
            get
            {
                if (SessionManager.Current[ResourceStrings.Session_CurrentPoll] != null)
                {
                    return (Poll)SessionManager.Current[ResourceStrings.Session_CurrentPoll];
                }
                return null;
            }
            set
            {
                SessionManager.Current[ResourceStrings.Session_CurrentPoll] = value;
            }
        }
    }
}
